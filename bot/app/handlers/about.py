...
async def about(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "about":
        ...
        about_text = f"🎮 DotaVision Bot\n\n" \
                     ...
                     f"📊 All the stats are opened, bot regularly posts all predictions in https://t.me/dota_vision\n\n" \
                     ...
                     f"📊 Вся статистика открыта, бот регулярно публикует все прогнозы в https://t.me/dota_vision\n\n" \
